...
//   the upload function takes in the input element as the first parameter
// and the file it wants to upload as the second.
...
test.skip("Clicking Upload button when two files have been selected should render a success message containing the file names", async () => {
    const user = userEvent.setup();
